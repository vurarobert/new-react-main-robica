document.addEventListener('DOMContentLoaded', function() {
    const socialLinks = [
        { name: 'Instagram', url: 'https://www.instagram.com/_vurarobert_' },
        { name: 'Facebook', url: 'https://www.facebook.com/vura.robert' },
        { name: 'GitHub', url: 'https://github.com/vurarobert' }
    ];
